...
public class Offline_SwipeListViewImpl_CompleteRW implements OnLayoutAnimatListener
{
    ...
    public void setMyadapter(String from, Context context, ExpandAniLinearLayout swipeListAni, List<RW_RW> list_RW_RW, ListView listView_fuwuchaxun)
    {
        ...
        swipeListAni.setOnLayoutAnimatListener(Offline_SwipeListViewImpl_CompleteRW.this);// ???????????
