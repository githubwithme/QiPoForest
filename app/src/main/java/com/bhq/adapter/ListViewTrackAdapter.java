 ...
 * 
 */
public class ListViewTrackAdapter extends BaseAdapter
{
	 ...
	 * @param resource
	 */
	public ListViewTrackAdapter(Context context, List<BHQ_XHQK> data, int resource)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		listItemView.tv_starttime.setText(utils.DateString2DateTime(bhq_XHQK.getXHKSSJ()));
		listItemView.tv_description.setText("暂停次数" + bhq_XHQK.getZTCS());
		listItemView.tv_endtime.setText(utils.DateString2DateTime(bhq_XHQK.getXHJSSJ()));
