...
public class ListViewEventAdapter extends BaseAdapter
{
	 ...
	 * @param resource
	 */
	public ListViewEventAdapter(Context context, List<BHQ_XHSJ> data, int resource)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		listItemView.tv_time.setText(utils.DateString2Date(bhq_XHSJ.getSBSJ()));
		BitmapHelper.setImageViewBackground(context, bhq_XHSJ.getSJID(), listItemView.img_plant);
		return convertView;
	}
}