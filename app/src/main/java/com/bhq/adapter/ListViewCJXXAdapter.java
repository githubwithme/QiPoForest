 ...
 * 
 */
public class ListViewCJXXAdapter extends BaseAdapter
{
	 ...
	 * @param data
	 */
	public ListViewCJXXAdapter(Context context, List<BHQ_XHSJCJ> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.plantlist_item, null);
		...
		listItemView.tv_zm.setText(BHQ_XHSJCJ.getZM());
		listItemView.tv_fl.setText(BHQ_XHSJCJ.getKE());
		...
		String aa = BHQ_XHSJCJ.getCJSJ().toString();
		listItemView.tv_fxsj.setText(utils.DateString2Date(BHQ_XHSJCJ.getCJSJ().toString()));
		BitmapHelper.setImageView(context, listItemView.img, AppConfig.url + BHQ_XHSJCJ.getIMGURL());
		return convertView;
	}
