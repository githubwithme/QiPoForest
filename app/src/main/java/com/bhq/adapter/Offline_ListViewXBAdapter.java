 ...
 * @created 2012-3-21
 */
public class Offline_ListViewXBAdapter extends BaseAdapter
{
	private Context context;// 运行上下文
	private List<XBBean> listItems;// 数据集合
	 ...
	 * @param resource
	 */
	public Offline_ListViewXBAdapter(Context context, List<XBBean> data, int resource)
	{
...
//					context.startActivity(intent);
		...
		// 设置文字和图片
		listItemView.tv_type.setText(XBBean.getXBH());
		listItemView.tv_description.setText("小班号:"+XBBean.getXBH());
		listItemView.tv_time.setText(XBBean.getDCSJ());
		List<FJ_SCFJ> list_FJ_SCFJ = SqliteDb.getFJ_SCFJList(context, FJ_SCFJ.class, XBBean.getID(), "1");
