...
public class Survey extends Activity implements OnClickListener
{
	...
	SurveyListFragment surveyListFragment_;

	@AfterViews
	void afterOncreate()
	{
		switchContent(mContent, surveyListFragment_);
	}
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		getActionBar().hide();
		surveyListFragment_ = new SurveyListFragment_();
	...
	private void showPop()
	{
		...
		popupWindow.showAsDropDown(imgbtn_search, 0, 0);
	...
	public void onClick(View v)
	{
		...
		{
		case R.id.btn_qmc:
			intent = new Intent(Survey.this, AddQMC_.class);
			popupWindow.dismiss();
			break;
		case R.id.btn_xmcbc:
			intent = new Intent(Survey.this, AddXMCBC_.class);
			popupWindow.dismiss();
			break;
		default:
			break;
