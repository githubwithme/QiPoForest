...
import com.bhq.R;
import com.bhq.adapter.ListViewAnimalKnowledgeAdapter;
 ...
 */
@EFragment
public class AnimalKnowledgeListFragment extends Fragment
{
	private AppContext appContext;// 全局Context
	private List<Animal> listData = new ArrayList<Animal>();
	private ListViewAnimalKnowledgeAdapter listAdapter;
	...
	{
		listAdapter = new ListViewAnimalKnowledgeAdapter(getActivity(), listData, R.layout.animalknowledge_listitem);
