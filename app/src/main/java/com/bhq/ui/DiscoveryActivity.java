...
import com.bhq.R;
import com.bhq.adapter.ListViewCJXXAdapter;
...
public class DiscoveryActivity extends Activity implements OnClickListener
{
	...
	private ListViewCJXXAdapter listAdapter;
...
//		ZYDL = "02";
	...
	public void onClick(View v)
	{
		...
		case R.id.btn_animal:
			intent = new Intent(DiscoveryActivity.this, AddCJXX_.class);
	...
	{
		dt_manager dt_manager = AppContext.getUserInfo(DiscoveryActivity.this);
		HashMap<String, String> hashMap = new HashMap<String, String>();
		hashMap.put("PAGESIZE", String.valueOf(PAGESIZE));
		hashMap.put("PAGEINDEX", String.valueOf(PAGEINDEX));
		hashMap.put("CJR", dt_manager.getid());
		hashMap.put("ZYDL", ZYDL);
		String params = ConnectionHelper.setParams("APP.GetBHQ_XHSJCJList", "0", hashMap);
		new HttpUtils().send(HttpRequest.HttpMethod.POST, AppConfig.dataBaseUrl, ConnectionHelper.getParas(params), new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				List<BHQ_XHSJCJ> listNewData = null;
				Result result = JSON.parseObject(responseInfo.result, Result.class);
				if (result.getResultCode() == 200)// 连接数据库成功
				{
					listNewData = JSON.parseArray(ResultDeal.getAllRow(result), BHQ_XHSJCJ.class);
					if (listNewData == null)
					{
				...
				{
					AppContext.makeToast(DiscoveryActivity.this, "error_connectDataBase");
					return;
				}
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(DiscoveryActivity.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
							NewDataToast.makeText(DiscoveryActivity.this, getString(R.string.new_data_toast_none), false, R.raw.newdatatoast).show();
						}
					}
					break;
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(DiscoveryActivity.this, "load_error");
				}
			...
			{
				AppContext.makeToast(DiscoveryActivity.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new ListViewCJXXAdapter(DiscoveryActivity.this, listData);
		list_footer = DiscoveryActivity.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
		...
		frame_listview_news.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (BHQ_XHSJCJ == null)
					return;
				Intent intent = new Intent(DiscoveryActivity.this, ShowCJXX_.class);
