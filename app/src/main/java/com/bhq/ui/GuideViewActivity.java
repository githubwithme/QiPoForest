...
import com.bhq.R;
import com.bhq.adapter.ViewPagerAdapter;
import com.bhq.app.AppManager;
import com.bhq.common.TrayNotification;

import java.util.ArrayList;

/**
 * @author HMJ
 * @version 功能描述： 1显示通知栏图标，实现引导界面， 2其后每次使用直接进入开屏界面
 */
public class GuideViewActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		} else
		{
			...
			editor.putString("model", "0");// 0为离线模式
			editor.commit();
		}
	}
