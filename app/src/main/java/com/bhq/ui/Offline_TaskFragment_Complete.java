 ...
 */
@EFragment
public class Offline_TaskFragment_Complete extends Fragment
{
	@ViewById
	...
	{
		View rootView = inflater.inflate(R.layout.taskfragment_complete, container, false);
		return rootView;
	}
	...
	private void getTask()
	{
		...
		List<RW_RW> list_rw = SqliteDb.getCompleteRenWuByRYID(getActivity(), dt_manager_offline.getid());
		if (list_rw == null)
		{
