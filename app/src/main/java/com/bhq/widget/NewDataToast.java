...
//	}
	...
	public NewDataToast(Context context, boolean isSound,int sound)
	{
		super(context);
	 ...
	 * @return
	 */
	public static NewDataToast makeText(Context context, CharSequence text, boolean isSound,int sound)
	{
		NewDataToast result = new NewDataToast(context, isSound,sound);
